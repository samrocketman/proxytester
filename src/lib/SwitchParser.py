...
class SwitchParser:
    ...
    def showhelp(self) :
        print "Proxy Tester and WPAD.dat Generator v0.8"
        ...
        print ""
        print "  fileList" + self.TAB +      "1 or more file paths to a proxy list.  It could also be a    "
        print self.TAB + self.TAB +          "single proxy server in x.x.x.x:port format.  Entries can be  "
        print self.TAB + self.TAB +          "mixed or matched."
        print ""
        ...
        print self.TAB + self.TAB +          "If -GET is not specified then proxytester will connect to a  "
        print self.TAB + self.TAB +          "default url. "
        print ""
        ...
        print "  Test a single (or group) of proxies by listing them:"
        print self.TAB +           "proxytester 192.168.1.1:8080"
        print ""
